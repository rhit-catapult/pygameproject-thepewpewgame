...
class AsteroidPiece:
    ...
    def draw(self, surface, gun1, gun2):
        self.gun1 = gun1
        self.gun2 = gun2
        if self.health <= 0:
            self.health = 0
            ...
            self.collider = pygame.draw.rect(surface, self.color, (self.x, self.y, self.width, self.height))
            self.check_collisions(self.gun1, self.gun2)
            self.color = (self.health*10, self.health*10, self.health*10)
            self.destroyed = False

    def check_collisions(self, gun, gun2):
        collide = False
        for other in gun.bullets:
            if other.type == 1:
                if self.collider.colliderect(other.x - 14, other.y - 3, 28, 6):
                ...
                if self.collider.colliderect(other.x - 5, other.y - 5, 10, 10) and abs(self.x-other.x)<100 and abs(self.y-other.y)<100:
                    ...
                    if self.health > 0:
                        for i in range(10):
                            gun2.bullets.append(Bullet(gun2.screen, other.x, other.y, 9, gun2.direction))
                        gun.bullets.remove(other)
                    collide = True
            elif other.type == 3:
                if self.collider.colliderect(other.x - 26, other.y - 2, 52, 4):
        ...
        for other in gun2.bullets:
            if other.type == 1:
                if self.collider.colliderect(other.x - 14, other.y - 3, 28, 6):
                    self.health -= other.damage
                    if self.health > 0:
                        gun2.bullets.remove(other)
                    collide = True
            elif other.type == 2:
                if self.collider.colliderect(other.x - 5, other.y - 5, 10, 10):
                    self.health -= other.damage
                    if self.health > 0:
                        for i in range(10):
                            gun2.bullets.append(Bullet(gun2.screen, other.x, other.y, 9, gun2.direction))
...
def main():
    ...
    for i in range(num_asteroids):
        ...
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x-(asteroid_width/5)-3, current_y-(asteroid_height/2.5)-6, asteroid_width / 5, asteroid_height / 5))
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x, current_y-(asteroid_height/2.5)-6, asteroid_width / 5, asteroid_height / 5))
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x+(asteroid_width/5)+3, current_y-(asteroid_height/2.5)-6, asteroid_width / 5, asteroid_height / 5))
        #if random.randint(0, 1) == 1:
        #    asteroids.append(AsteroidPiece(x+(asteroid_width/2.5)+6, current_y-(asteroid_height/2.5)-6, asteroid_width / 5, asteroid_height / 5))
        ...
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x - (asteroid_width / 2.5) - 6, current_y-(asteroid_height/5)-3, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x - (asteroid_width / 5) - 3, current_y-(asteroid_height/5)-3, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x, current_y-(asteroid_height/5)-3, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x + (asteroid_width / 5) + 3, current_y-(asteroid_height/5)-3, asteroid_width / 5, asteroid_height / 5))
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x + (asteroid_width / 2.5) + 6, current_y-(asteroid_height/5)-3, asteroid_width / 5, asteroid_height / 5))

        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x - (asteroid_width / 2.5) - 6, current_y, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x - (asteroid_width / 5) - 3, current_y, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x, current_y, asteroid_width / 5, asteroid_height / 5))
        asteroids.append(AsteroidPiece(x + (asteroid_width / 5) + 3, current_y, asteroid_width / 5, asteroid_height / 5))
        if random.randint(0, 1) == 1:
            asteroids.append(AsteroidPiece(x + (asteroid_width / 2.5) + 6, current_y, asteroid_width / 5, asteroid_height / 5))
    ...
    while True:
        ...
        for asteroid in asteroids:
            if not asteroid.return_destroyed():
                asteroid.draw(screen, gun1, gun2)
            else:
